...
export function DhyanaVahiniJourney() {
  ...
  return (
    <section className="rounded-[2rem] border border-[#e8dcc9] bg-[linear-gradient(135deg,_#fcf8ee_0%,_#f3e6ce_100%)] p-6 shadow-[0_20px_60px_rgba(75,54,29,0.08)] sm:p-8 lg:p-12 xl:p-14 2xl:p-16">
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-base leading-8 text-[#5f4a32]">{journey.description}</p>
      </div>
      ...
      <div className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        {journey.items.map((item) => (
          ...
          >
            ...
            <p className="mt-3 text-sm leading-7 text-[#5f4a32]">Continue exploring this inspiring path.</p>
          </a>
        ))}
      </div>
    </section>
