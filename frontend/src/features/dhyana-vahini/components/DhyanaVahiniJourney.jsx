  ...
  return (
    <section className="rounded-[2rem] border border-border bg-surface p-6 shadow-md sm:p-8 lg:p-12 xl:p-14 2xl:p-16">
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-base leading-8 text-foreground">{journey.description}</p>
      </div>
      ...
      <div className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        {journey.items.map((item) => (
          ...
          >
            ...
            <p className="mt-3 text-sm leading-7 text-foreground">Continue exploring this inspiring path.</p>
          </a>
        ))}
      </div>
    </section>
