...
/**
 * A collapsible archive card for a past (completed) year of Netritvam issues.
 * Collapsed: a single "folder" card. Click to expand the year's issue grid
 * inline. Each archive card manages its own open/closed state.
 */
export function NetritvamYearArchive({ year, issues }) {
