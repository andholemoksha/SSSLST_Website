    ...
    highlights: [
        {
            ...
            description:
                "Every lasting leadership skill is built on an honest understanding of yourself.",
        },
        {
            title: "Practice, not theory",
            description:
                "Our course is built around real exercises and reflection, not lectures alone.",
        },
        {
