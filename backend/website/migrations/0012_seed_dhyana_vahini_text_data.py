"""Data migration: seed the initial 2026 Dhyana Vahini written reflections.
...
NOTE: Some participants have multiple reflections (different weeks). These are
stored with a '-W2' suffix on the roll_number to satisfy the unique constraint.
"""
...
INITIAL_REFLECTIONS = [
    ...
    {
        'roll_number': 'MP26-M201-W2',
        'name': 'Shivam Kumar Sahu',
        'reflection': 'Today, I had the blessed opportunity to participate in the Summer Pyaoo Seva organized by our Jabalpur Samithi at Platform No. 4 & 5 of Jabalpur Junction. A special seva stall has been set up there, where earthen pots are continuously filled to keep the water cool and refreshing. As soon as a train arrives, we fill large water containers and carry them through trolleys towards the trains. The greatest need is often in the general coaches, where passengers are unable to step out to fill water because the trains are extremely crowded, leaving hardly any space to move. In such situations, we quickly collect their bottles through the windows and refill them using funnels and mugs. The moment they receive cool drinking water, a beautiful smile and a sense of relief instantly appear on their faces.',
    },
    {
    ...
    {
        'roll_number': 'OD26-F106-W2',
        'name': 'Shivani Singh',
        'reflection': 'After many days, I attended Bhajan again. Since I had gone to my village, I was unable to attend for some time. During these days, I was also feeling stressed and tense regarding my job and future, which made my mind feel heavy and restless. Attending Bhajan after such a long gap gave me a sense of peace and relief. In the beginning, my mind was distracted, but slowly, while listening to and singing Bhajans, I started feeling calm and connected. This experience reminded me that whenever life feels uncertain or stressful, connecting with God and attending Bhajans helps bring inner peace, strength, and clarity.',
    },
    {
    ...
    {
        'roll_number': 'HR26-F101-W2',
        'name': 'Deepanshi Chhillar',
        'reflection': 'With love and devotion, let us offer the Sai Namavali at His divine lotus feet. Reading the Sri Sathya Sai Namavali gave me a deep sense of peace and inner calm that is difficult to express in words. With every Divine Name I chanted, my mind slowly became quiet, my heart felt lighter, and all the stress and confusion within me started fading away. It felt as if Swami\u2019s love and blessings were surrounding me completely. For those few moments, I forgot every worry and simply felt connected to Him. Even after finishing the Namavali, the calmness remained within me, reminding me that whenever I feel lost or disturbed, taking Swami\u2019s name will always bring me back to peace and light.',
    },
    {
    ...
    {
        'roll_number': 'AP26-F112-W2',
        'name': 'Natti Deepika',
        'reflection': 'Sairam. In our Samithi, we are conducting Maggam and Zardozi work training classes. This course runs for 45 days, from 10:00 AM to 1:00 PM every day. I am helping by giving them cloth cuttings, providing materials for the items, and taking attendance. I support them in whatever way I can during the class. Through this training, many women are learning useful skills, and I truly feel that this will help them become independent and settle in their lives. It makes me very happy to be part of this service. Being able to contribute, even in a small way, gives me a lot of satisfaction and joy. I feel blessed to serve and support them in building a better future.',
    },
    {
    ...
    {
        'roll_number': 'ME26-F204-W2',
        'name': 'Trupti Rohan Khanorkar',
        'reflection': 'I participated in the promotional activities for Shri Sathya Sai Run & Ride (Sundays on Cycle). We encouraged people to participate in this marathon for the spirit of unity championing the mission of Fit India. Sai Ram.',
    },
    {
